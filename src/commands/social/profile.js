...
const Bank = require('../../structures/economy/bank');
const Currency = require('../../structures/economy/currency');
const Experience = require('../../structures/economy/experience');
...
module.exports = class ProfileCommand extends Command {
    ...
    async run(msg, { member }) {
        ...
        const canvas = new Canvas.Canvas(300, 300);
        ...
        base.src = await fs.readFileAsync(path.join(__dirname, '..', '..', 'assets', 'backgrounds', `${profile ? profile.background : 'default'}.png`)); // eslint-disable-line max-len
